...
vertexai.init(project="cloud-assignment-418012", location="us-central1")  #<-CHANGED
parameters = {                                                 #<-CHANGED
...
def generate():
    ...
    lang = check(args, "lang", LANG)  # Add this line
    prompt = PROMPT.format(topic=topic, num_q=num_q, diff=diff, lang=lang)  # Include lang here
